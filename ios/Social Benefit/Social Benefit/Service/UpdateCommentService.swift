...
class UpdateCommentService {
    ...
    func getAPI(id: Int, contentId: Int, contentType: Int, parentId: Int, content: String, returnCallBack: @escaping (Int) -> ()) {
        ...
        service.makeCall(endpoint: Config.API_COMMENT_UPDATE, method: "POST", header: header as [String : String], body: params, callback: { result in
