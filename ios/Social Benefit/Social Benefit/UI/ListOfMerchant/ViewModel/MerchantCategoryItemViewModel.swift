...
//    @Published var allMerchantCategoryItem = [MerchantCategoryItemData]()
    ...
    @Published var allMerchantCategoryItem = allMerchanCategoryItemDebug
...
let allMerchanCategoryItemDebug = [MerchantCategoryItemData(id: 1, imgSrc: "https://i.imgur.com/YGMw0La.png", title: "Coffee"),
