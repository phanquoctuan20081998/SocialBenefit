...
let allSpecialOffersDebug = [
    ...
    MerchantVoucherItemData(id: 1841, voucherCode: 0, imageURL: "", name: "Ưu đãi giá tiền taxi", merchantName: "Công ty giầy thể thao Triệu Sơn", content: "<p>123</p>", favoriteValue: 2, outOfDateTime: Date(), shoppingValue: 1, pointValue: 900000, moneyValue: 1000000000, discountValue: -10, categoryId: -1, merchantId: -1, employeeLikeThis: true),
