...
struct BenefitDetailView: View {
    ...
    func getApplyButton() -> some View {
        if self.benefitDetailViewModel.applyStatus == 0 {
            applyButtonView(text: "waiting_to_conform".localized, textColor: Color(#colorLiteral(red: 0.2712115049, green: 0.5014922023, blue: 0.91060853, alpha: 1)), backgroundColor: Color(#colorLiteral(red: 0.9607003331, green: 0.9608382583, blue: 0.9606701732, alpha: 1)), disable: true)
        } else if self.benefitDetailViewModel.applyStatus == 1 {
        ...
        } else if self.benefitDetailViewModel.applyStatus == 2 {
        ...
        } else if self.benefitDetailViewModel.applyStatus == 3 {
